(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('parse5'), require('preact')) :
    typeof define === 'function' && define.amd ? define(['exports', 'parse5', 'preact'], factory) :
    (factory((global.preactHtmlConverter = {}),global.parse5,global.preact));
}(this, (function (exports,parse5,preact) { 'use strict';

    var parser = {
        parseFragment: function (htmlString) {
            return parse5.parseFragment(htmlString);
        },
        serialize: function (element) {
            return parse5.serialize(element);
        }
    };
