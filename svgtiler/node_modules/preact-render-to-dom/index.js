...
var CHILDREN, COMMIT, COMPONENT, CSS_REGEX, DIFF, DIFFED, DIRTY, HOOKS, HTML_LOWER_CASE, IS_NON_DIMENSIONAL, JS_TO_CSS, NAMESPACE_REPLACE_REGEX, PARENT, RENDER, SKIP_EFFECTS, SVGNS, SVG_CAMEL_CASE, UNSAFE_NAME, VNODE, createComponent, markAsDirty, styleObjToCss,
  indexOf = [].indexOf;
...
export var RenderToDom = class RenderToDom {
  ...
  renderClassComponent(vnode, context) {
    ...
    if (type.getDerivedStateFromProps != null) {
      c.state = {...c.state, ...type.getDerivedStateFromProps(c.props, c.state)};
...
export var RenderToXMLDom = class RenderToXMLDom extends RenderToDom {
  constructor(options) {
    var xmldom;
...
export var RenderToJSDom = class RenderToJSDom extends RenderToDom {
  constructor(options) {
    var jsdom;
    jsdom = options.jsdom;
    if (jsdom.JSDOM != null) {
